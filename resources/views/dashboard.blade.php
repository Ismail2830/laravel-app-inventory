                ...
                <div class="card-header ">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            ...
                            <h2 class="card-title">Annual Sales</h2>
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i> MAD {{ number_format($semesterincomes, 2)  }} </h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-bank text-info"></i> MAD {{ number_format($monthlybalance, 2)  }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-paper text-success"></i>MAD {{ number_format($semesterexpenses, 2)  }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                            ...
                            <tbody>
                                @foreach ($unfinishedsales as $sale)
                                    <tr>
                                        ...
                                        <td>MAD {{ number_format($sale->transactions->sum('amount'), 2) }}</td>
                                        <td>MAD {{ number_format($sale->products->sum('total_amount'), 2) }}</td>
                            ...
                            <tbody>
                                ...
                                @foreach($lasttransactions as $transaction)
                                    <tr> 
                                        ...
                                        <td>MAD {{ number_format($transaction->amount , 2) }}</td>
                                        <td class="td-actions text-right">
